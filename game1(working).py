...
def menu(exits):
    ...
    while True:           
        ...
        selection = input("") 
        # Normalise the input
        selection_input = normalise_input(selection)
        # Check if the input makes sense (is valid exit)
            # If so, return the player's choice
        if is_valid_exit(exits, selection_input):
...
def move(exits, direction):
    ...
    False
    """
    #print((rooms["name"]["exits"], rooms["name"]["direction"]) == rooms["name"]
